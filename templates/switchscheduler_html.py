...
<body>
    <div class=\"container\">
        <div class=\"schedule-form\">
            <h1>Switch Scheduler</h1>
            <label for=\"pin-select\">Select GPIO Pin:</label>
            <select id=\"pin-select\">
                <option value=\"0\">Switch 0</option>
        ...
        <div class=\"schedule-table\">
            ...
            <table id=\"schedule-table\">
                ...
                <tbody>
                    <!-- Scheduled items will be displayed here -->
                </tbody>
            </table>
        </div>
    </div>
    ...
    yield """{'Content-Type': 'application/json'},
                body: JSON.stringify("""
    yield """{pin: pin, on_time: onTime, off_time: offTime})
            });
    ...
    yield """{pin}</td>
                    <td>$"""
    yield """{schedule[pin].on_time}</td>
                    <td>$"""
    yield """{schedule[pin].off_time}</td>
                `;
